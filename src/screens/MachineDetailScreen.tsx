...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: Colors.surface, height: 131, paddingHorizontal: 50, justifyContent: 'flex-start', paddingTop: 50 },
  backButton: { position: 'absolute', left: -22, top: 53, zIndex: 10 },
  logoSmall: { width: 60, height: 40, marginRight: -30, marginTop: 53 },
